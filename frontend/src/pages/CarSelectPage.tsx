...
function CarSelectPage({ carConfigs, onSelectCar, selectedCarId }: CarSelectPageProps) {
  return (
    <main className="min-h-svh bg-[#f5f4f2] text-[#1f2328]">
      ...
      <section className="mx-auto grid min-h-[calc(100svh-81px)] max-w-[1400px] grid-rows-[auto_1fr] gap-8 px-8 py-10 max-[760px]:px-4 max-[760px]:py-6">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,minmax(340px,1fr))] content-start gap-6">
